...
import { _ as _export_sfc, t as toPosterThumbnail, a as getPluginApi, p as postPluginApi, o as openNativeSubscription } from './api-CE1QTgMg.js';
import { d as doubanDispatchUrl, u as useRankMediaActions, s as sourceDescriptor } from './useRankMediaActions-CGjnpgJ_.js';
                              ...
                              _createElementVNode("div", _hoisted_10, [
                                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(group.items, (item) => {
                                  return (_openBlock(), _createElementBlock("a", {
                                    ...
                                    (item.poster && !timelineImageFailed.value[item.key])
                                      ? (_openBlock(), _createBlock(_component_VImg, {
                                          ...
                                          cover: "",
                                          class: "rounded",
                                          onError: $event => (markTimelineImageFailed(item.key))
                                        }, null, 8, ["src", "onError"]))
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-40a4e1cd"]]);
