...
from .candidate import normalize_media_identity
...
class OutcomeAttribution:
    ...
    def __post_init__(self) -> None:
        ...
        source, media_id = normalize_media_identity(
            self.media_source or ("themoviedb" if self.tmdb_id else ""),
            self.media_id or self.tmdb_id,
        )
        object.__setattr__(self, "media_source", source)
