...
const _hoisted_9 = { class: "text-caption mx-1" };
    ...
    _createElementVNode("div", _hoisted_2, [
      ...
      (total.value > pageSize)
        ? (_openBlock(), _createElementBlock("div", _hoisted_8, [
            ...
            _createElementVNode("span", _hoisted_9, _toDisplayString(page.value) + " / " + _toDisplayString(totalPages.value) + "（共 " + _toDisplayString(total.value) + " 条）", 1),
            _createVNode(_component_VBtn, {
              size: "x-small",
              variant: "tonal",
