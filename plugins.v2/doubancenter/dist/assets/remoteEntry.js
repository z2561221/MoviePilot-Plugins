const currentImports = {};
      ...
      let moduleMap = {
"./Config":()=>{
      dynamicLoadingCss(["__federation_expose_Config-DFQ0bB2A.css"], false, './Config');
      return __federation_import('./__federation_expose_Config-BJe0ohSG.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},
"./Page":()=>{
