...
const {resolveComponent:_resolveComponent,createVNode:_createVNode,withCtx:_withCtx,createTextVNode:_createTextVNode,toDisplayString:_toDisplayString,renderList:_renderList,Fragment:_Fragment,openBlock:_openBlock,createElementBlock:_createElementBlock,createElementVNode:_createElementVNode,normalizeClass:_normalizeClass,vShow:_vShow,withDirectives:_withDirectives,createCommentVNode:_createCommentVNode} = await importShared('vue');
...
const _hoisted_12 = { class: "dc-rank-list-1col" };
const _hoisted_13 = { class: "dc-rank-card-header" };
const _hoisted_14 = { class: "dc-rank-card-body" };
const _hoisted_15 = { class: "dc-rank-field" };
const _hoisted_16 = {
  key: 0,
  class: "dc-rank-field"
};
...
const _hoisted_20 = { class: "dc-pane" };
const _hoisted_21 = { class: "dc-pane" };
const _hoisted_22 = { class: "dc-pane" };
...
const defaults = {
  ...
  dashboard_rank_keys: [],
  blacklist_keywords: '',        // 黑名单关键词，一行一个
  observe_days: 0,               // 观察期天数，0为不启用
  anti_cheat_enabled: false,     // 防刷榜开关
  anti_cheat_min_vote: 5.0,      // TMDB最低评分阈值
};
          ...
          _createElementVNode("section", _hoisted_4, [
            ...
            _createElementVNode("div", _hoisted_7, [
              _withDirectives(_createElementVNode("div", _hoisted_8, [
                _cache[27] || (_cache[27] = _createElementVNode("div", { class: "dc-section-title" }, "基础设置", -1)),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_9, [
                _createElementVNode("div", _hoisted_10, [
                  _cache[28] || (_cache[28] = _createTextVNode("榜单列表 ", -1)),
                    ...
                    return _createElementVNode("div", {
                      ...
                      _createElementVNode("div", _hoisted_14, [
                        _createElementVNode("div", _hoisted_15, [
                          _cache[29] || (_cache[29] = _createElementVNode("span", { class: "dc-rank-label" }, "数量", -1)),
                          _createVNode(_component_VTextField, {
                        ...
                        (rd.filters.includes('wish_count'))
                          ? (_openBlock(), _createElementBlock("div", _hoisted_16, [
                              _cache[30] || (_cache[30] = _createElementVNode("span", { class: "dc-rank-label" }, "想看", -1)),
                              _createVNode(_component_VTextField, {
                        ...
                        (rd.filters.includes('air_days'))
                          ? (_openBlock(), _createElementBlock("div", _hoisted_17, [
                              _cache[31] || (_cache[31] = _createElementVNode("span", { class: "dc-rank-label" }, "窗口", -1)),
                              _createVNode(_component_VTextField, {
                        ...
                        (rd.filters.includes('vote'))
                          ? (_openBlock(), _createElementBlock("div", _hoisted_18, [
                              _cache[32] || (_cache[32] = _createElementVNode("span", { class: "dc-rank-label" }, "评分", -1)),
                              _createVNode(_component_VTextField, {
                        ...
                        (rd.filters.includes('year'))
                          ? (_openBlock(), _createElementBlock("div", _hoisted_19, [
                              _cache[33] || (_cache[33] = _createElementVNode("span", { class: "dc-rank-label" }, "年份", -1)),
                              _createVNode(_component_VTextField, {
                ...
                _cache[34] || (_cache[34] = _createElementVNode("div", { class: "dc-section-title mt-4" }, "自定义榜单", -1)),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_20, [
                _cache[37] || (_cache[37] = _createElementVNode("div", { class: "dc-section-title" }, "条件筛选", -1)),
                _createVNode(_component_VRow, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_VCol, {
                      cols: "12",
                      ...
                      default: _withCtx(() => [
                        ...
                        _cache[35] || (_cache[35] = _createElementVNode("div", { class: "dc-hint" }, "即将上映专用", -1))
                      ]),
                      _: 1
                    }),
                    _createVNode(_component_VCol, {
                      ...
                      default: _withCtx(() => [
                        ...
                        _cache[36] || (_cache[36] = _createElementVNode("div", { class: "dc-hint" }, "即将上映专用", -1))
                      ]),
                      _: 1
                    })
                  ]),
                ...
                _cache[38] || (_cache[38] = _createElementVNode("div", { class: "dc-section-title" }, "防刷榜设置", -1)),
                _createVNode(_component_VRow, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_VCol, {
                      cols: "12",
              ...
              _withDirectives(_createElementVNode("div", _hoisted_21, [
                _cache[39] || (_cache[39] = _createElementVNode("div", { class: "dc-section-title" }, "同步设置", -1)),
                _createVNode(_component_VRow, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_VCol, {
                      cols: "12",
              ...
              _withDirectives(_createElementVNode("div", _hoisted_22, [
                _cache[40] || (_cache[40] = _createElementVNode("div", { class: "dc-section-title" }, "仪表盘选择", -1)),
                _createVNode(_component_VAlert, {
                  type: "info",
                  variant: "tonal",
                  density: "compact",
                ...
                _cache[41] || (_cache[41] = _createElementVNode("div", { class: "dc-section-title mt-4" }, "档案时间线显示设置", -1)),
                _createVNode(_component_VRow, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_VCol, {
                      cols: "12",
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-a696e95d"]]);
