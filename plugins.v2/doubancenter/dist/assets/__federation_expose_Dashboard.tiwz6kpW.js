...
function doOpenDouban() {
  ...
  showDialog.value = false;
  // 优先用douban_id，其次从link提取subject_id，最后用tmdbid
  const subjectId = item.douban_id || (item.link ? (item.link.match(/subject\/(\d+)/) || [])[1] : null) || '';
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-52fdb31f"]]);
