...
const _hoisted_7 = { class: "dc-timeline-label" };
const _hoisted_8 = { class: "dc-poster-strip" };
const _hoisted_9 = ["href", "title"];
const _hoisted_10 = {
  key: 1,
  class: "dc-poster-placeholder-md"
};
const _hoisted_11 = {
  key: 2,
  class: "dc-rank-grid"
};
const _hoisted_12 = { class: "dc-rank-title" };
const _hoisted_13 = { class: "dc-rank-list" };
const _hoisted_14 = ["title", "onClick"];
const _hoisted_15 = { class: "dc-rank-item-title" };
const _hoisted_16 = { class: "dc-rank-item-meta" };
const _hoisted_17 = {
  key: 0,
  class: "dc-rank-empty"
};
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createElementVNode("div", _hoisted_2, [
      _createElementVNode("div", _hoisted_3, [
        ...
        _cache[0] || (_cache[0] = _createElementVNode("div", null, [
          _createElementVNode("div", { class: "text-subtitle-1 font-weight-bold" }, "豆瓣中心"),
    ...
    _createElementVNode("div", _hoisted_4, [
            ...
            _createVNode(_component_VCard, {
              ...
              default: _withCtx(() => [
                _createVNode(_component_VCardItem, { class: "pa-2" }, {
                  ...
                  default: _withCtx(() => [
                    _createVNode(_component_VCardTitle, { class: "text-subtitle-2 font-weight-bold pa-0" }, {
                    ...
                    _createElementVNode("div", _hoisted_6, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(timelineGroups.value, (group) => {
                        return (_openBlock(), _createElementBlock("div", {
                          ...
                          _createElementVNode("div", _hoisted_7, _toDisplayString(group.label), 1),
        ...
        ? (_openBlock(), _createElementBlock("div", _hoisted_11, [
            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(config.value.dashboard_rank_keys, (rk) => {
              return (_openBlock(), _createElementBlock("div", {
                ...
                _createElementVNode("div", _hoisted_12, _toDisplayString(rankDefs[rk]?.name||rk), 1),
      ...
      (!loading.value && !config.value.dashboard_rank_keys?.length && !timelineGroups.value.length)
        ? (_openBlock(), _createElementBlock("div", _hoisted_18, " 请在配置页「仪表显示」中选择要显示的榜单 "))
        : _createCommentVNode("", true)
    ])
  ]))
}
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-7ea3d2a6"]]);
