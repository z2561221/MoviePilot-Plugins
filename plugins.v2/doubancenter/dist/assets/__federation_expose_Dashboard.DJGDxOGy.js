...
const _hoisted_9 = { class: "dc-rank-grid" };
const _hoisted_10 = { class: "dc-rank-head" };
const _hoisted_11 = { class: "dc-rank-body" };
const _hoisted_12 = ["title", "onClick"];
const _hoisted_13 = { class: "dc-rank-name" };
const _hoisted_14 = { class: "dc-rank-num" };
const _hoisted_15 = {
  key: 0,
      ...
      _createVNode(_component_VCardText, { class: "pa-3" }, {
        default: _withCtx(() => [
          ...
          (timelineGroups.value.length)
            ? (_openBlock(), _createElementBlock("div", _hoisted_1, [
                _createElementVNode("div", _hoisted_2, [
                  ...
                  _cache[3] || (_cache[3] = _createElementVNode("span", { class: "text-body-2 font-weight-medium" }, "追影时间线", -1)),
                ...
                _createElementVNode("div", _hoisted_3, [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(timelineGroups.value, (group) => {
                    return (_openBlock(), _createElementBlock("div", {
                      ...
                      _createElementVNode("div", _hoisted_4, _toDisplayString(group.label), 1),
                ...
                _createElementVNode("div", _hoisted_9, [
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(config.value.dashboard_rank_keys, (rk) => {
                    return (_openBlock(), _createElementBlock("div", {
                      ...
                      _createElementVNode("div", _hoisted_10, _toDisplayString(rankDefs[rk]?.name||rk), 1),
          ...
          (!loading.value && !config.value.dashboard_rank_keys?.length && !timelineGroups.value.length)
            ? (_openBlock(), _createElementBlock("div", _hoisted_16, " 请在配置页「仪表显示」中选择要显示的榜单 "))
            : _createCommentVNode("", true)
        ]),
        _: 1
      })
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-42be6f23"]]);
