...
function showContextMenu(e, rk, item) {
  menuItem.value = { rk, item };
  ...
  return (_openBlock(), _createBlock(_component_VCard, {
    ...
    default: _withCtx(() => [
                ...
                _createElementVNode("div", _hoisted_2, [
                  _createElementVNode("div", _hoisted_3, [
                    _createElementVNode("div", _hoisted_4, [
                      ...
                      _cache[6] || (_cache[6] = _createTextVNode("追影时间线", -1))
                    ]),
                      ...
                      _createElementVNode("div", _hoisted_14, [
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList((rankHistory.value[rk]||[]).slice(0,5), (item, i) => {
                          return (_openBlock(), _createElementBlock("div", {
                            ...
                            class: "dc-rank-row",
                            title: item.title,
                            onClick: _withModifiers($event => (showContextMenu($event, rk, item)), ["stop"])
                          }, [
                            _createVNode(_component_VAvatar, {
                              size: "16",
      ...
      _createVNode(_component_VMenu, {
        ...
        "position-x": menuPos.value.x,
        "position-y": menuPos.value.y,
        absolute: ""
      }, {
        default: _withCtx(() => [
          _createVNode(_component_VList, {
            ...
            default: _withCtx(() => [
              _createVNode(_component_VListItem, {
                onClick: _cache[0] || (_cache[0] = $event => {menuItem.value && subscribe(menuItem.value.rk, menuItem.value.item); showMenu.value=false;}),
                "prepend-icon": "mdi-plus-circle-outline",
                title: "订阅",
                class: "rounded"
              }),
              _createVNode(_component_VListItem, {
                onClick: _cache[1] || (_cache[1] = $event => {menuItem.value && _ctx.window.open(menuItem.value.item.link, '_blank'); showMenu.value=false;}),
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-156a415c"]]);
