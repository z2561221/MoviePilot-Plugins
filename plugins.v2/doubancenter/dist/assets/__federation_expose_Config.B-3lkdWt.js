...
const _hoisted_12 = { class: "dc-table-wrap" };
const _hoisted_13 = { class: "dc-col-enable" };
const _hoisted_14 = { class: "dc-table-strong" };
const _hoisted_15 = { key: 0 };
const _hoisted_16 = { key: 1 };
const _hoisted_17 = { key: 2 };
const _hoisted_18 = { key: 3 };
const _hoisted_19 = { class: "dc-pane" };
            ...
            _createElementVNode("div", _hoisted_7, [
              ...
              _withDirectives(_createElementVNode("div", _hoisted_9, [
                ...
                _createElementVNode("div", _hoisted_12, [
                  _createVNode(_component_VTable, { class: "dc-rank-table" }, {
                    default: _withCtx(() => [
                      _createElementVNode("thead", null, [
                        _createElementVNode("tr", null, [
                          _cache[25] || (_cache[25] = _createElementVNode("th", {
                            scope: "col",
                            class: "dc-col-enable"
                          }, "启用", -1)),
                          _cache[26] || (_cache[26] = _createElementVNode("th", { scope: "col" }, "榜单", -1)),
                          _cache[27] || (_cache[27] = _createElementVNode("th", { scope: "col" }, "数量", -1)),
                          (_openBlock(), _createElementBlock(_Fragment, null, _renderList(['wish_count','air_days','vote','year'], (f) => {
                            return _withDirectives(_createElementVNode("th", {
                              scope: "col",
                              key: f
                            }, _toDisplayString({wish_count:'想看人数',air_days:'播出窗口',vote:'评分',year:'年份'}[f]), 1), [
                              [_vShow, rankDefs.some(r=>r.filters.includes(f))]
                            ])
                          }), 64))
                        ])
                      ]),
                      _createElementVNode("tbody", null, [
                        (_openBlock(), _createElementBlock(_Fragment, null, _renderList(rankDefs, (rd) => {
                          return _createElementVNode("tr", {
                            ...
                            _createElementVNode("td", _hoisted_14, _toDisplayString(rd.name), 1),
                            ...
                            (rd.filters.includes('year'))
                              ...
                              : _createCommentVNode("", true),
                            (!rd.filters.includes(_ctx.f))
                              ? (_openBlock(), _createElementBlock(_Fragment, { key: 4 }, _renderList(['wish_count','air_days','vote','year'], (f) => {
                ...
                _cache[28] || (_cache[28] = _createElementVNode("div", { class: "dc-section-title mt-4" }, "自定义榜单", -1)),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_19, [
                _cache[31] || (_cache[31] = _createElementVNode("div", { class: "dc-section-title" }, "条件筛选", -1)),
                _createVNode(_component_VRow, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_VCol, {
                      cols: "12",
                      ...
                      default: _withCtx(() => [
                        ...
                        _cache[29] || (_cache[29] = _createElementVNode("div", { class: "dc-hint" }, "即将上映专用", -1))
                      ]),
                      _: 1
                    }),
                    _createVNode(_component_VCol, {
                      ...
                      default: _withCtx(() => [
                        ...
                        _cache[30] || (_cache[30] = _createElementVNode("div", { class: "dc-hint" }, "即将上映专用", -1))
                      ]),
                      _: 1
                    })
                  ]),
              ...
              _withDirectives(_createElementVNode("div", _hoisted_20, [
                _cache[32] || (_cache[32] = _createElementVNode("div", { class: "dc-section-title" }, "同步设置", -1)),
                _createVNode(_component_VRow, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_VCol, {
                      cols: "12",
              ...
              _withDirectives(_createElementVNode("div", _hoisted_21, [
                _cache[33] || (_cache[33] = _createElementVNode("div", { class: "dc-section-title" }, "仪表盘选择", -1)),
                _createVNode(_component_VAlert, {
                  type: "info",
                  variant: "tonal",
                  density: "compact",
                ...
                _cache[34] || (_cache[34] = _createElementVNode("div", { class: "dc-section-title mt-4" }, "档案时间线显示设置", -1)),
                _createVNode(_component_VRow, null, {
                  default: _withCtx(() => [
                    _createVNode(_component_VCol, {
                      cols: "12",
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-182ca090"]]);
