...
const _hoisted_8 = { class: "text-caption text-medium-emphasis mr-1" };
                        ...
                        default: _withCtx(() => [
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList((rankHistory.value[rk]||[]).slice(0,5), (item, i) => {
                            return (_openBlock(), _createBlock(_component_VListItem, {
                              ...
                              append: _withCtx(() => [
                                _createElementVNode("span", _hoisted_8, _toDisplayString(item.year||''), 1),
                                _createVNode(_component_VChip, {
                                  size: "x-small",
                                  color: "primary",
                                  variant: "flat"
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-87f392c0"]]);
