...
const _hoisted_2 = { class: "text-caption text-medium-emphasis mr-1" };
const _hoisted_3 = {
  key: 2,
  class: "dc-timeline"
};
const _hoisted_4 = { class: "dc-section-label mb-2" };
const _hoisted_5 = { class: "d-flex align-center mb-1" };
const _hoisted_6 = { class: "dc-month-label" };
const _hoisted_7 = {
                        ...
                        default: _withCtx(() => [
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList((rankHistory.value[rk]||[]).slice(0,5), (item, i) => {
                            return (_openBlock(), _createBlock(_component_VListItem, {
                              ...
                              append: _withCtx(() => [
                                _createElementVNode("span", _hoisted_2, _toDisplayString(item.year||''), 1),
          ...
          (timelineGroups.value.length)
            ? (_openBlock(), _createElementBlock("div", _hoisted_3, [
                _createElementVNode("div", _hoisted_4, [
                  ...
                  _cache[8] || (_cache[8] = _createTextVNode("追剧观影记录", -1))
                ]),
                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(timelineGroups.value, (group) => {
                  return (_openBlock(), _createElementBlock("div", {
                    ...
                    _createElementVNode("div", _hoisted_5, [
                      _createElementVNode("span", _hoisted_6, _toDisplayString(group.label), 1),
                      _createVNode(_component_VChip, {
                        size: "x-small",
                        color: "primary",
                        variant: "tonal",
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-0a5c0014"]]);
