...
const _hoisted_1 = {
  key: 1,
  class: "dc-timeline mb-4"
};
const _hoisted_2 = { class: "dc-section-label mb-2" };
const _hoisted_3 = { class: "d-flex align-center mb-1" };
const _hoisted_4 = { class: "dc-month-label" };
const _hoisted_5 = {
...
const _hoisted_9 = { class: "text-caption text-medium-emphasis mr-1" };
...
async function refreshRss() {
  ...
  refreshResult.value = '';
  try {
    const keys = config.value?.dashboard_rank_keys || [];
    const res = await postPluginApi(props.api, 'refresh_rss', { rank_keys: keys });
    refreshResult.value = res.success ? `✓ RSS已刷新` : `✗ ${res.message}`;
    rankHistory.value = await getPluginApi(props.api, 'rank_history') || {};
          ...
          (timelineGroups.value.length)
            ? (_openBlock(), _createElementBlock("div", _hoisted_1, [
                _createElementVNode("div", _hoisted_2, [
                  ...
                  _cache[6] || (_cache[6] = _createTextVNode("追剧观影记录", -1))
                ]),
                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(timelineGroups.value, (group) => {
                  return (_openBlock(), _createElementBlock("div", {
                    key: group.monthKey,
                    class: "dc-month-group mb-3"
                  }, [
                    _createElementVNode("div", _hoisted_3, [
                      _createElementVNode("span", _hoisted_4, _toDisplayString(group.label), 1),
                        ...
                        default: _withCtx(() => [
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList((rankHistory.value[rk]||[]).slice(0,5), (item, i) => {
                            return (_openBlock(), _createBlock(_component_VListItem, {
                              ...
                              append: _withCtx(() => [
                                _createElementVNode("span", _hoisted_9, _toDisplayString(item.year||''), 1),
                                _createVNode(_component_VChip, {
                                  size: "x-small",
                                  color: "primary",
                                  variant: "flat"
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-45dd9fe7"]]);
