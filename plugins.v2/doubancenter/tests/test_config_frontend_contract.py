...
class ConfigFrontendContractTest(unittest.TestCase):
    ...
    def test_rank_list_uses_compact_grid_style(self):
        ...
        self.assertIn(
            ".dc-rank-card-body { display: grid; grid-template-columns: 110px 80px 80px 160px 92px 108px;",
            text,
        )
        ...
        self.assertIn(
            "grid-template-columns:110px80px80px160px92px108px",
            compact_css,
        )
