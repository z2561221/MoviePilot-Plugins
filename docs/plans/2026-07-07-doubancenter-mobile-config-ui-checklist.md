...
- [x] 5. Final offline diff review
  ...
  - evidence: staged implementation diff contained only this checklist, `Config.vue`, Config build assets, and `remoteEntry.js`; MP local repository sync/install/reload was intentionally skipped because it is offline.
  - commit: `17b59b0`
